<template>
  <div>
    <h1 class="flex justify-center md:text-3xl p-4 font-bold">Our Mentors</h1>
    <!-- <div>
      <DropDownMenu />
    </div> -->
    <ul
    ...
    >
      <!-- class="bg-gradient-to-r from-custom-blue to-blue-200" -->
      <li
          ...
          <div class="flex flex-col">
            ...
            <div class="justify-between">
              <button
                ...
                class="mt-auto bg-custom-blue hover:bg-blue-500 transition duration-300 text-white px-3 py-1 rounded-3xl text-xl shadow-sm"
              >
                More
              </button>
            </div>
    ...
    async getMentorDatas() {
      axios
        ...
        .then((response) => {
          ...
          // console.log(this.mentorDatas[0].price);
        })
        .catch((error) => {
          console.log(error);
        });

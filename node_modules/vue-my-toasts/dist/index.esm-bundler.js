/*!
  ...
  * @license MIT
  */
import { getCurrentInstance, onUnmounted, unref, watch, ref, set, del, reactive, computed, nextTick, defineComponent, onBeforeMount, onBeforeUnmount, h, TransitionGroup, withDirectives, createApp } from 'vue-demi';
...
var MyToasts = defineComponent({
    ...
    render({ full, position, width, padding, toasts, leaving, leave, toastVariants, component, remove, }) {
        return h('div', {
            ...
            }, () => toasts.map((toast, index) => withDirectives(h('li', {
                key: toast.id,
                'data-id': toast.id,
            }, [
                h(component, {
...
const updateConfig = (newOptions, userComponent) => {
    ...
    updateConfig$1(pluginOptions, currentComponent);
};
/**
...
export { TimerMixin, ToastMixin, currentComponent, defineToastComponent, pluginOptions, updateConfig, useToasts };
